$(document).ready(function() {
  ...
  $("table").each(function() {
    ...
    $(tableWrap).scroll(function() {
      ...
      if (tableScroll == tableWidth - wrapWidth) {
        ...
        $(this)
          .removeClass("shadow-rl shadow-r")
          .addClass("shadow-l");
      } else if (tableScroll > 0) {
        // Show left and right shadows when table can scroll both ways
        $(this)
          .removeClass("shadow-l shadow-r")
          .addClass("shadow-rl");
      } else {
        // Show right shadow when table can only scroll right
        $(this)
          .removeClass("shadow-l shadow-rl")
          .addClass("shadow-r");
      }
    });
  ...
  $("a.details").click(function() {
    ...
    $(this)
      ...
      .toggleClass("open");
    $(this).html(
      $(this).html() == "Show details" ? "Hide details" : "Show details"
    );
    return false;
  });
});
